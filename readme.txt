...
A post editor tool for displaying the HTML generated by ClassicPress shortcodes.

== Description ==
The Shortcode Tester is a post editor tool for ClassicPress developers that displays in a popup window the HTML generated by ClassicPress shortcodes, i.e. so you can quickly view the generated HTML without having to view the entire post. Please visit [https://github.com/magenta-cuda/shortcode-tester/blob/master/README.md](https://github.com/basic-tech/classic-shortcode-tester/blob/master/README.md) for a very quick introduction.

== Installation ==
1. Download the [plugin from the GitHub repository](https://github.com/basic-tech/classic-shortcode-tester/archive/master.zip).
2. Open the 'Plugins' menu item and activate the plugin.
3. Read the tutorial at [https://github.com/basic-tech/classic-shortcode-tester/blob/master/README.md](https://github.com/basic-tech/classic-shortcode-tester/blob/master/README.md).
