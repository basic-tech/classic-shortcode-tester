...
/*
    ...
    The "Classic Shortcode Tester" is a fork of the "ShortCode Tester" a post editor tool for WordPress developers that
    displays in a popup window the HTML generated by WordPress shortcodes. The "Classic Shortcode Tester" is designed to
    work with the old TinyMCE editor of ClassicPress.
*/
