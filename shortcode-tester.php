...
/*
 * Description:   Classic Shortcode Tester
 * Documentation: https://github.com/basic-tech/classic-shortcode-tester
 * Author:        Basic Tech
 * License:       GPL2
 */
...
/*
    Classic Shortcode Tester
    
    The "Classic Shortcode Tester" is fork of the "ShortCode Tester" a post editor tool for WordPress developers that
    displays in a popup window the HTML generated by WordPress shortcodes, i.e. so you can quickly view the generated
    HTML. The "Classic Shortcode Tester" is designed to work with the old TinyMCE editor.
*/
